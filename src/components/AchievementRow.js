    ...
    return (
        <View style={{ backgroundColor: colors.surface, borderRadius: 14, padding: 12 }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 6 }}>
                ...
                <Text style={{ color: unlocked ? colors.textUnlocked : colors.textDim, fontWeight: '700' }}>
            ...
            <View style={{ height: 10, backgroundColor: '#0b1220', borderRadius: 999, overflow: 'hidden' }}>
                <View style={{ height: '100%', width: `${pct * 100}%`, backgroundColor: unlocked ? colors.bar : colors.primary }} />
            </View>
            {unlockedAt ? (
                <Text style={{ color: colors.textUnlocked, marginTop: 6, fontSize: 12 }}>
